...
public class TestCreateQRCode {
    ...
    public static void main(String[] args) {
        // 最后生成的图片地址
        String imgPath = "E:\\logo_QRCode.png";
        // 加入的logo照片
        String imgPath1 = "E:\\heart.jpg";
        String content = "Hello！金^(*￣(oo)￣)^ hah 惊不惊喜???!!!";
        TestCreateQRCode testCreateQRCode = new TestCreateQRCode();
        boolean boo = testCreateQRCode.createQRCode(content, imgPath, imgPath1);
